 ...
 * @version V1.0
 */
public class ZKConnectSessionDemo implements Watcher {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		ZooKeeper zk = new ZooKeeper(zkServerPath, timeout, new ZKConnectSessionDemo());
		...
		System.out.println("连接状态zk：" + zk.getState());
		...
		ZooKeeper zkSession = new ZooKeeper(zkServerPath, timeout, new ZKConnectSessionDemo(), sessionId, sessionPassword);
		System.out.println("连接状态zkSession：" + zkSession.getState());
		new Thread().sleep(2000);
		System.out.println("连接状态zkSession：" + zkSession.getState());
	}
